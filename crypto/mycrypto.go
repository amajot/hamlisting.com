...
// Package hamlistings/crypto consolidates crypto funcionality used by the application
package crypto
...
func NewV4UUID() string {
	...
	b := u[:]
	return strings.ToLower(fmt.Sprintf("%X-%X-%x-%X%X-%x",
